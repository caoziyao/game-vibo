import GuaAnimation  from '../../game/game_animation'

import Tool  from '../../game/utils'

const rectIntersects = Tool.rectIntersects

export default class Bird extends GuaAnimation {
    constructor(game) {
        super(game)
        this.game = game
        // 编码
